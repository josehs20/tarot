...
@section('content')
            ...
            <div class="nano-content">
                <ul>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-home"></i> Dashboard <span
                        ...
                        <ul>
                            <li><a href="index.html">Estatísticas</a></li>
                            <li><a href="index.html">Atendimentos</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="app-email.html"><i class="ti-user"></i> Administradores</a></li>
                    <li><a href="app-profile.html"><i class="ti-user"></i> Atendentes</a></li>
                    ...
                    <li><a href="app-widget-card.html"><i class="ti-file"></i> Contato</a></li>
                    <li><a href="app-widget-card.html"><i class="ti-file"></i> Depoimentos</a></li>
                    <li><a href="app-widget-card.html"><i class="ti-file"></i> Dúvidas e FAQ</a></li>
                    <li><a href="app-widget-card.html"><i class="ti-file"></i> Email Marketing</a></li>
                    <li><a href="app-widget-card.html"><i class="ti-file"></i> Configurações</a></li>
                    <li><a href="app-widget-card.html"><i class="ti-file"></i> Pedidos</a></li>
                    <li><a href="app-widget-card.html"><i class="ti-file"></i> Política De Privacidade</a></li>
                    <li><a href="app-widget-card.html"><i class="ti-file"></i> Produtos</a></li>
                    <li><a href="app-widget-card.html"><i class="ti-file"></i> Programa Fidelidade</a></li>
                    <li><a href="app-widget-card.html"><i class="ti-file"></i> Promoções</a></li>
                    <li><a href="app-widget-card.html"><i class="ti-file"></i> Quem Somos</a></li>
                    <li><a href="app-widget-card.html"><i class="ti-file"></i> Slides</a></li>
                    <li><a href="app-widget-card.html"><i class="ti-file"></i> Slides De Texto</a></li>
                    <li><a href="app-widget-card.html"><i class="ti-file"></i> Trabalhe Conosco</a></li>
    ...
    <!-- jquery vendor -->
    <script src="js/admin/js/lib/jquery.min.js"></script>
    <script src="js/admin/js/lib/jquery.nanoscroller.min.js"></script>
    <!-- nano scroller -->
    <script src="js/admin/js/lib/menubar/sidebar.js"></script>
    <script src="js/admin/js/lib/preloader/pace.min.js"></script>
    <!-- sidebar -->

    <script src="js/admin/js/lib/bootstrap.min.js"></script>
    <script src="js/admin/js/scripts.js"></script>
    <!-- bootstrap -->

    <script src="js/admin/js/lib/calendar-2/moment.latest.min.js"></script>
    <script src="js/admin/js/lib/calendar-2/pignose.calendar.min.js"></script>
    <script src="js/admin/js/lib/calendar-2/pignose.init.js"></script>


    <script src="js/admin/js/lib/weather/jquery.simpleWeather.min.js"></script>
    <script src="js/admin/js/lib/weather/weather-init.js"></script>
    <script src="js/admin/js/lib/circle-progress/circle-progress.min.js"></script>
    <script src="js/admin/js/lib/circle-progress/circle-progress-init.js"></script>
    <script src="js/admin/js/lib/chartist/chartist.min.js"></script>
    <script src="js/admin/js/lib/sparklinechart/jquery.sparkline.min.js"></script>
    <script src="js/admin/js/lib/sparklinechart/sparkline.init.js"></script>
    <script src="js/admin/js/lib/owl-carousel/owl.carousel.min.js"></script>
    <script src="js/admin/js/lib/owl-carousel/owl.carousel-init.js"></script>
    <!-- scripit init-->
    <script src="js/admin/js/dashboard2.js"></script>
@endsection
